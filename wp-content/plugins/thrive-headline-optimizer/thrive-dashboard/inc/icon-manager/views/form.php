<form action="" method="post">
	...
	<div class="tvd-row">
		<div class="tvd-col tvd-s12 tvd-m3 tvd-l2">
			<?php echo esc_html__( "Upload Icon Pack", TVE_DASH_TRANSLATE_DOMAIN ) ?>
		</div>
		<div class="tvd-col tvd-s12 tvd-m9 tvd-l10">
			...
			<a class="tvd-waves-effect tvd-waves-light tvd-btn-small tvd-btn-green" id="tve_icon_pack_upload" href="javascript:void(0)">
				<i class="tvd-icon-plus"></i> <?php echo esc_html__( "Upload", TVE_DASH_TRANSLATE_DOMAIN ) ?>
			</a>

			<a class="tvd-waves-effect tvd-waves-light tvd-btn-small tvd-btn-red" id="tve_icon_pack_remove" href="javascript:void(0)">
				<i class="tvd-icon-remove"></i> <?php echo esc_html__( "Remove", TVE_DASH_TRANSLATE_DOMAIN ) ?>
			</a>
		</div>
	...
	<div class="tvd-row">
		<div class="tvd-col tvd-s12 tvd-m3 tvd-l2">
			<?php echo esc_html__( "Save options", TVE_DASH_TRANSLATE_DOMAIN ) ?>
		</div>
		<div class="tvd-col tvd-s12 tvd-m9 tvd-l10">
			<input type="submit" id="tve_icon_pack_save" value="<?php echo esc_html__( "Save and Generate Icons", TVE_DASH_TRANSLATE_DOMAIN ) ?>" class="tvd-waves-effect tvd-waves-light tvd-btn-small tvd-btn-blue"/>
		</div>
	</div>
</form>
