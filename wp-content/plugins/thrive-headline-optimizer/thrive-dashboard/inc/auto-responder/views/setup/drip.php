...
<div class="tvd-row">
	<form class="tvd-col tvd-s12">
		...
		<div class="tvd-input-field">
			...
			<label for="tvd-d-client-id"><?php echo esc_html__( "Client ID", TVE_DASH_TRANSLATE_DOMAIN ) ?></label>
		</div>
		<div class="tvd-input-field">
			<input id="tvd-d-api-token" type="text" name="connection[token]"
				   value="<?php echo esc_attr( $this->param( 'token' ) ); ?>">
			<label for="tvd-d-api-token"><?php echo esc_html__( "API token", TVE_DASH_TRANSLATE_DOMAIN ) ?></label>
		</div>
