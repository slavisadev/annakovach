<table style="border: 1px solid #e5e5e5; padding: 20px;">
	...
	<tr>
		...
		<td>
			...
			<a style="font-size: 16px; background-color: <?php echo $color_picker_value ?>; padding: 5px 15px; text-decoration: none; color: #fff; display: inline-block;" href="<?php echo get_permalink( $comment->comment_post_ID ) . '#comments/' . $comment->comment_ID ?>"><?php echo $labels['reply_to']['text']?></a>
		</td>
	</tr>
	<tr>
		<td colspan="2"><hr style="margin: 30px 0; border: none; border-bottom: 1px solid #e5e5e5;"></td>
	</tr>
	<tr>
