<form action="" method="post" style="margin-top: 10px">
	...
	<div class="tvd-row">
		<div class="tvd-col tvd-s12 tvd-m2 tvd-l1">
			<?php echo esc_html__( "Upload Fonts", TVE_DASH_TRANSLATE_DOMAIN ) ?>
		</div>
	...
	<div class="tvd-row">
		...
		<div class="tvd-col tvd-s12 tvd-m10 tvd-l11">
			<input type="submit" value="<?php echo esc_html__( "Save and Generate Fonts", TVE_DASH_TRANSLATE_DOMAIN ) ?>" class="tvd-waves-effect tvd-waves-light tvd-btn-small tvd-btn-blue"/>
		</div>
