...
<div class="tvd-row">
	<form class="tvd-col tvd-s12">
		...
		<div class="tvd-input-field">
			...
			<label for="tvd-mm-zoho-url"><?php echo esc_html__( 'Account Url', TVE_DASH_TRANSLATE_DOMAIN ) ?></label>
		</div>

		<div class="tvd-input-field">
			<input id="tvd-mm-api-client-id" type="text" name="connection[client_id]"
				   value="<?php echo esc_attr( $this->param( 'client_id' ) ); ?>">
			<label for="tvd-mm-api-client-id"><?php echo esc_html__( 'Zoho Client ID', TVE_DASH_TRANSLATE_DOMAIN ) ?></label>
		</div>
		...
		<div class="tvd-input-field">
			...
			<label for="tvd-mm-api-client-secret"><?php echo esc_html__( 'Zoho Client Secret', TVE_DASH_TRANSLATE_DOMAIN ) ?></label>
		</div>
		...
		<?php if ( empty( $this->param( 'account_url' ) ) ) : ?>
			<div class="tvd-input-field">
				...
				<label for="tvd-mm-api-code"><?php echo esc_html__( 'Access Code', TVE_DASH_TRANSLATE_DOMAIN ) ?></label>
			</div>
		<?php else: ?>
