...
?>
<div data-css="tve-u-16d632405fa" class="thrv_wrapper tve-tqb-page-type tqb-optin-template-2 tve_editor_main_content" style="<?php echo esc_attr( $main_content_style ); ?>">
