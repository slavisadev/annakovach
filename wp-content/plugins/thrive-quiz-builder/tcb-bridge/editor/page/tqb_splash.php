...
<div id="tqb-editor-replace">
	...
	<div style="opacity: .6; padding-top: 240px; text-align: center; position: relative; z-index: -1;">
		<h4><?php echo esc_html__( 'This is a Variation type called "Splash page". It is displayed on posts that have its code in the content.', Thrive_Quiz_Builder::T ) ?></h4>
	</div>
</div>
