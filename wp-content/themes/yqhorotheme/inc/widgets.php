    ...
    function widget($args, $instance)
    {
      ...
      <div class="c-widget c-widget--sidebar c-widget-author">
        <div class="c-widget-author__media">
          <a href="http://annakovach.com">
            <img alt="" src="https://annakovach.com/wp-content/uploads/2019/07/6635-300x300.jpg"
        ...
        <div class="c-widget-author__content">
          <h3 class="c-widget-author__title">
            <a href="http://annakovach.com">Anna Kovach</a>
          </h3>
          <p class="c-widget-author__bio">
            ...
            If you’d like, you can learn <a href="http://annakovach.com">more about me on this page here</a>.
          </p>
        </div>
      </div>
        <?php
        ...
        <h5 class="c-widget--sidebar__title">Recent Posts</h5>
          ...
          if ($query->have_posts()) :
              while ($query->have_posts()) :
                  $query->the_post();
                  $featuredImage = get_the_post_thumbnail_url(get_the_ID(), (array(64,48)), 'blog_featured_regular');
                  ?>
                <a
