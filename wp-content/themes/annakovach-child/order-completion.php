...
if (isset($_SESSION['h_user_id']) && $_SESSION['h_user_id'] != '') {

    $row = ORM::for_table('wp_user_details')->where('user_id', $_SESSION['h_user_id'])->find_one();
    ...
    if ($row->save()) {
        ...
        $sendMail->sendOrderCompletionPdf($_SESSION['h_user_id']);
    ...
    header('Location: https://annakovach.com/free-birth-chart/');
    exit;
}
