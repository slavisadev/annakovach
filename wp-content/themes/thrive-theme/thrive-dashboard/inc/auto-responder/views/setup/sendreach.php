...
<div class="tvd-row">
	<form class="tvd-col tvd-s12">
		...
		<div class="tvd-input-field">
			...
			<label for="tvd-sr-api-key"><?php echo esc_html__( "Key", TVE_DASH_TRANSLATE_DOMAIN ) ?></label>
		</div>
		<div class="tvd-input-field">
			<input id="tvd-sr-api-secret" type="text" name="connection[secret]"
				   value="<?php echo esc_attr( $this->param( 'secret' ) ); ?>">
			<label for="tvd-sr-api-secret"><?php echo esc_html__( "Secret", TVE_DASH_TRANSLATE_DOMAIN ) ?></label>
		</div>
