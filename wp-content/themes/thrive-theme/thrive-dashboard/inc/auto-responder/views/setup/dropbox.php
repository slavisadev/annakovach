...
<div class="tvd-row">
	<form class="tvd-col tvd-s12">
		...
		<div class="tvd-input-field">
			...
			<label for="tvd-db-api-client-id"><?php echo esc_html__( 'App key', TVE_DASH_TRANSLATE_DOMAIN ); ?></label>
		</div>
		<div class="tvd-input-field">
			...
			<label for="tvd-db-api-client-secret"><?php echo esc_html__( 'App secret', TVE_DASH_TRANSLATE_DOMAIN ); ?></label>
		</div>
