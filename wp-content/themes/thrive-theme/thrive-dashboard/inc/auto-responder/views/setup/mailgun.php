...
<div class="tvd-row">
	<form class="tvd-col tvd-s12">
		...
		<div class="tvd-input-field">
			...
			<label for="tvd-mg-api-domain"><?php echo esc_html__( "Mailgun-approved domain name", TVE_DASH_TRANSLATE_DOMAIN ) ?></label>
		</div>
		<div class="tvd-input-field">
			<input id="tvd-mg-api-key" type="text" name="connection[key]"
				   value="<?php echo esc_attr( $this->param( 'key' ) ); ?>">
			<label for="tvd-mg-api-key"><?php echo esc_html__( "API key", TVE_DASH_TRANSLATE_DOMAIN ) ?></label>
		</div>
		<div class="tvd-input-field">
			<select id="tvd-mailgun-zone" type="text" name="connection[zone]">
				<option value="worldwide"><?php echo esc_html__( 'Worldwide', TVE_DASH_TRANSLATE_DOMAIN ) ?></option>
				<option value="europe"><?php echo esc_html__( 'Europe', TVE_DASH_TRANSLATE_DOMAIN ) ?></option>
			</select>
			<label for="tvd-mailgun-zone"><?php echo esc_html__( 'Email Zone', TVE_DASH_TRANSLATE_DOMAIN ) ?></label>
		</div>
...
<div class="tvd-row">
	<div class="tvd-col tvd-12">
		<p class="tve-form-description tvd-note-text">
			<?php echo esc_html__( 'Note: Sending through Mailgun only works if your domain name has been set and verified within your Mailgun account.', TVE_DASH_TRANSLATE_DOMAIN ) ?>
			<a href="https://help.mailgun.com/hc/en-us/articles/202052074-How-do-I-verify-my-domain-" target="_blank"><?php echo esc_html__( 'Learn more', TVE_DASH_TRANSLATE_DOMAIN ) ?></a>.
		</p>
	</div>
</div>
